...
=======
        "\n(define-fungible-token stackaroo)\n(ft-mint? stackaroo u100 '0x8Ba97376e9d63Eb9A5Cd53caFEefB335AF762d87)\n(ft-get-balance stackaroo '0x8Ba97376e9d63Eb9A5Cd53caFEefB335AF762d87) ;; Returns u100\n",
>>>>>>> 528f06b (upload)
    },
    {
      name: 'nft-get-owner?',
...
=======
        "\n(define-fungible-token stackaroo)\n(ft-mint? stackaroo u100 '0x8Ba97376e9d63Eb9A5Cd53caFEefB335AF762d87)\n(ft-transfer? stackaroo u50 '0x8Ba97376e9d63Eb9A5Cd53caFEefB335AF762d87 'SPAXYA5XS51713FDTQ8H94EJ4V579CXMTRNBZKSF) ;; Returns (ok true)\n(ft-transfer? stackaroo u60 'SZ2J6ZY48GV1EZ5V2V5RB9MP66SW86PYKKQ9H6DPR 'SPAXYA5XS51713FDTQ8H94EJ4V579CXMTRNBZKSF) ;; Returns (err u1)\n",
>>>>>>> 528f06b (upload)
    },
    {
      name: 'nft-transfer?',
...
=======
        '\n(define-non-fungible-token stackaroo (string-ascii 40))\n(nft-mint? stackaroo "Roo" \'0x8Ba97376e9d63Eb9A5Cd53caFEefB335AF762d87)\n(nft-transfer? stackaroo "Roo" \'0x8Ba97376e9d63Eb9A5Cd53caFEefB335AF762d87 \'SPAXYA5XS51713FDTQ8H94EJ4V579CXMTRNBZKSF) ;; Returns (ok true)\n(nft-transfer? stackaroo "Roo" \'SZ2J6ZY48GV1EZ5V2V5RB9MP66SW86PYKKQ9H6DPR \'SPAXYA5XS51713FDTQ8H94EJ4V579CXMTRNBZKSF) ;; Returns (err u1)\n(nft-transfer? stackaroo "Stacka" \'SZ2J6ZY48GV1EZ5V2V5RB9MP66SW86PYKKQ9H6DPR \'SPAXYA5XS51713FDTQ8H94EJ4V579CXMTRNBZKSF) ;; Returns (err u3)\n',
>>>>>>> 528f06b (upload)
    },
    {
      name: 'nft-mint?',
...
=======
        "`stx-get-balance` is used to query the GTFX Balance of the `owner` principal.\n\nThis function returns the GTFX Balance of the `owner` principal. In the event that the `owner`\nprincipal isn't materialized, it returns 0.\n",
      example:
        "\n(stx-get-balance '0x8Ba97376e9d63Eb9A5Cd53caFEefB335AF762d87) ;; Returns u0\n(stx-get-balance (as-contract tx-sender)) ;; Returns u1000\n",
>>>>>>> 528f06b (upload)
    },
    {
      name: 'stx-transfer?',
...
=======
        "`stx-transfer?` is used to increase the SGTFX Balance for the `recipient` principal\nby debiting the `sender` principal. The `sender` principal _must_ be equal to the current context's `tx-sender`.\n\nThis function returns (ok true) if the transfer is successful. In the event of an unsuccessful transfer it returns\none of the following error codes:\n\n`(err u1)` -- `sender` does not have enough balance to transfer\n`(err u2)` -- `sender` and `recipient` are the same principal\n`(err u3)` -- amount to send is non-positive\n`(err u4)` -- the `sender` principal is not the current `tx-sender`\n",
      example:
        "\n(as-contract\n  (stx-transfer? u60 tx-sender '0x8Ba97376e9d63Eb9A5Cd53caFEefB335AF762d87)) ;; Returns (ok true)\n(as-contract\n  (stx-transfer? u50 '0x8Ba97376e9d63Eb9A5Cd53caFEefB335AF762d87 tx-sender)) ;; Returns (err u4)\n",
>>>>>>> 528f06b (upload)
    },
    {
      name: 'stx-burn?',
...
=======
        "\n(as-contract\n  (stx-burn? u60 tx-sender)) ;; Returns (ok true)\n(as-contract\n  (stx-burn? u50 '0x8Ba97376e9d63Eb9A5Cd53caFEefB335AF762d87)) ;; Returns (err u4)\n",
>>>>>>> 528f06b (upload)
    },
    {
