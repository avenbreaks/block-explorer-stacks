...
=======
            This address participated in the Staking token offering. Its GTFX is subject to the
>>>>>>> 528f06b (upload)
...
=======
              <Caption>This table only shows data from after the launch of GitEdgeware 1.0</Caption>
>>>>>>> 528f06b (upload)
            </Stack>
          </Section>
          <Table />
